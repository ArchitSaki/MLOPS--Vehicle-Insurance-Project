...
class Proj1Data:
    ...
    def export_collection_as_dataframe(self, collection_name: str, database_name: Optional[str] = None) -> pd.DataFrame:
        ...
        -------
        pd.DataFrame
            DataFrame containing the collection data with '_id' removed.
        """
        try:
            # Determine correct database
            db_name = database_name or self.mongo_client.database_name

            # Access database and collection properly
